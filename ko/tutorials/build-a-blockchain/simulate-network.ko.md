...
- [Rust와 Rust 도구 체인](/install/)을 설치하여 Substrate 개발을 위한 환경을 구성했는지 확인하세요.
...
- 블록체인과 스마트 계약 플랫폼에 대해 일반적으로 알고 있는지 확인하세요.
...
| `--chain local`                                             | 사용할 체인 사양을 지정합니다. 유효한 사전 정의된 체인 사양으로는 `local`, `development`, `staging`이 있습니다.                                                                                                             |
...
- 생성한 키를 사용하는 사용자 정의 체인 사양을 생성하는 방법.

- 사용자 정의 체인 사양을 사용하는 개인 네트워크에 유효성 검사자를 추가하는 방법.
