...
기존의 오프체인 데이터 통합 방법은 전통적인 소스에서 데이터를 제공하기 위해 [오라클](../basic/glossary.md#오라클)에 연결하는 것입니다.
...
![오프체인 워커](/media/images/docs/infrablockchain/learn/substrate/learn/off-chain-workers-v2.png)
