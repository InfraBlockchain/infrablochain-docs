...
결정론적 런타임을 빌드하는 방법에 대한 자세한 내용은 [결정론적 런타임 빌드](../../../build/build-a-deterministic-runtime.md)를 참조하십시오.
...
파라체인을 등록하려면 릴레이 체인이 파라체인에 대한 [제네시스 상태](../../../build/genesis-configuration.md)를 알아야 합니다.
...
- [로컬 릴레이 체인 준비](../../../../../tutorials/build/build-infra-relay-chain.md)
- [로컬 파라체인 연결](../../../../../tutorials/build/build-a-parachain.md)