---
title: 거래, 가중치 및 수수료
description: 리소스를 실행하는 데 필요한 자원을 Substrate 가중치 시스템과 거래 수수료 계산을 통해 계산하는 방법을 설명합니다.
keywords:
---
...
- `Config::OnChargeTransaction`을 사용하여 거래 수수료의 인출, 환불 및 예치를 관리합니다.
...
<!-- - [가중치 계산](/reference/how-to-guides/weights/) -->