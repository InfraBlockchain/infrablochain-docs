...
The way to do it is through a [JSON-RPC](../learn/basic/glossary.md#json-rpc) proxy that is able to inspect calls and only pass an allowed set of API calls.
...
The information returned by these calls can be useful for testing purposes with tools like [`try-runtime`](../learn/command-line-tools/try-runtime.md).
...
For more information about encoding and decoding information, see [Type encoding (SCALE)](../learn/frame/scale-codec.md).
...
- [Type encoding (SCALE)](../learn/frame/scale-codec.md)
- [Runtime storage](../learn/frame/runtime-storage.md)
