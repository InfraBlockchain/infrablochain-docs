...
1. Modify the plain chain specification (optional):
   ...
   For example, this can be quite useful in the [Prepare a local relay chain](../../../../../tutorials/build/build-infra-relay-chain.md) where we want to create a custom _relay chain_ without customizing Polkadot's source.
